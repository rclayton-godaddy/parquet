...
// base
// go run cmd/parquetgen/main.go -input performance/message/message.go -type Message -package base  -output performance/base/parquet.go -import github.com/rclayton-godaddy/parquet/performance/message
// optimized
// go run cmd/parquetgen/main.go -input performance/message/message.go -type Message -package performance  -output performance/parquet.go -import github.com/rclayton-godaddy/parquet/performance/message
type Message struct {
